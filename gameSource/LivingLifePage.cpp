...
LivingLifePage::LivingLifePage() 
        : mServerSocket( -1 ), 
          ...
          mSayField( mainFont, 0, 1000, 10, false, NULL,
                     "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.-,'?!/\"()^~ ", NULL, true ),
          mDeathReason( NULL ),
...
char *LivingLifePage::getHintMessage( int inObjectID, int inIndex, bool reverse, int inDoNotPointAtThis ) {
